...
Listado.prototype.buscarRestaurante = function (id) {
    ...
    //     }
    // }
    var idRestaurante = this.restaurantes.find(restaurant => restaurant.id === id);
    
    //return "No se ha encontrado ningún restaurant";
    return idRestaurante === undefined ? "No se ha encontrado ningún restaurant" : idRestaurante;
}

function eliminarExistentes(objeto) {
    return objeto.filter(function (elemento, indice, parametro) {
        return indice === parametro.indexOf(elemento);
    });
}
...
Listado.prototype.obtenerUbicaciones = function () {
    ...
    // }
    ciudadesExistentes = this.restaurantes.map((restaurante) => {
    ...
    // });
    var ciudadesNuevas = eliminarExistentes(ciudadesExistentes);

    //return c2.sort();
    return ciudadesNuevas.sort();
}
...
Listado.prototype.obtenerRubros = function () {
    //var r = [];
    var rubrosExistentes = [];
    // for (var i = 0; i < this.restaurantes.length; i++) {
    //     r.push(this.restaurantes[i].rubro);
    // }
    rubrosExistentes = this.restaurantes.map((restaurante) => {
    ...
    //     return index === self.indexOf(elem);
    // });
    var rubrosNuevos = eliminarExistentes(rubrosExistentes);

    //return r2.sort();
    return rubrosNuevos.sort();
}
...
Listado.prototype.obtenerHorarios = function () {
    ...
    // }
    horariosExistentes = this.restaurantes.map((restaurante) => {
    ...
    //     return index === self.indexOf(elem);
    // });
    var horariosNuevos = eliminarExistentes(horariosExistentes);

    //return h2.sort();
    return horariosNuevos.sort();
}
